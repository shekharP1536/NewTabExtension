...
function check() {
  ...
  if (loc == "customf") {
    console.log("f");
    main.style.backgroundImage = "url('/assets/taj.jpg')";
  } else {
    console.log("light mode");
  }
}
// document.getElementById('custom_img_upload').addEventListener("click", custom_img);
// function custom_img(){
//   // console.log('Hii');
// }